      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          if (constraints.maxWidth > 900) {
            return WideLayout(authService: widget.authService);
          } else {
            return NarrowLayout(authService: widget.authService);
          }
        },
      ),
    );
...
class NarrowLayout extends StatefulWidget {
  final AuthService? authService;
  @override
  NarrowLayout({Key? key, this.authService}) : super(key: key);
...
class WideLayout extends StatefulWidget {
  final AuthService? authService;
  @override
  WideLayout({Key? key, this.authService}) : super(key: key);

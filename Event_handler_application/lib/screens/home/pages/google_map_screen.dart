...
import 'package:event_handler/screens/home/utilities/side_filter.dart';
...
class NarrowLayout extends StatefulWidget {
  final setSlidingUpPanelFuncion;
  @override
  NarrowLayout({Key? key, this.setSlidingUpPanelFuncion}) : super(key: key);
          ...
          "color": "#17263c"
                  ...
                  Container(
                    margin: EdgeInsets.only(
                      top: size_screen.height / 5.8,
                    ),
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(30),
                    ),
                    height: size_screen.height / 18,
...
class WideLayout extends StatefulWidget {
  final setSlidingUpPanelFuncion;
  @override
  WideLayout({Key? key, this.setSlidingUpPanelFuncion}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Container(
                  color: Colors.transparent,
                  height: size_screen.height * 0.26,
                  child: Stack(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
          ...
          "color": "#17263c"
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        margin: EdgeInsets.only(
                            top: size_screen.height / 3,
                            left: size_screen.width / 30),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(30),
                        ),
                        height: size_screen.height / 2.7,
                        child: SingleChildScrollView(
                          scrollDirection: Axis.vertical,
                          primary: false,
                          child: FittedBox(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[0].location),
                                    backgroundColor: Color(_locations[0].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[1].location),
                                    backgroundColor: Color(_locations[1].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[2].location),
                                    backgroundColor: Color(_locations[2].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[3].location),
                                    backgroundColor: Color(_locations[3].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[4].location),
                                    backgroundColor: Color(_locations[4].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                                ...
                                Padding(
                                  ...
                                  child: FilterChip(
                                    ...
                                    shadowColor: Colors.grey[60],
                                    selected: _filters
                                        .contains(_locations[5].location),
                                    backgroundColor: Color(_locations[5].color),
                                    //padding: EdgeInsets.all(6),
                                    onSelected: (bool selected) {
                                      setState(() {
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        top: size_screen.height / 5.5,
                        left: size_screen.width * 0.925),
                    child: FloatingActionButton(
                      heroTag: 'toggle_map_type_button',
                      onPressed: _onToggleMapTypePressed,
                      materialTapTargetSize: MaterialTapTargetSize.padded,
